import { useCreateInterviewFeedback } from '@/api/interviews-api';
...
import type { CreateInterviewFeedbackCommandCorrected } from '@/types/interview-types';
...
}) satisfies z.ZodType<CreateInterviewFeedbackCommandCorrected>;

export function AddFeedbackDialog({ interviewId, candidateId }: Props) {
    const [open, setOpen] = useState(false);
    const createFeedbackMutation = useCreateInterviewFeedback();
    ...
    const onSubmit = async (data: CreateInterviewFeedbackCommandCorrected) => {
