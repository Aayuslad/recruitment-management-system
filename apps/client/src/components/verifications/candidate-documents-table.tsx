...
export function CandidateDocumentsTable({ candidateId }: Porps) {
    ...
    const columns: ColumnDef<CandidateDocumentDetailDTO>[] = [
        {
            accessorKey: 'name',
            header: () => <div className="w-[210px] ml-4">Document Name</div>,
            cell: ({ row }) => (
        ...
        {
            accessorKey: 'url',
            header: () => <div className="w-[110px]">URL</div>,
            cell: ({ row }) => (
                <a
        ...
        },
        {
            id: 'verified-by',
            header: () => {
                return <div className="w-[200px]">Verified By</div>;
            },
            cell: ({ row }) => (
    ...
    return (
        <div className="w-full">
            ...
            <div className="flex items-center justify-between py-4">
                ...
                <AddDocument candidateId={candidateId} />
            </div>
