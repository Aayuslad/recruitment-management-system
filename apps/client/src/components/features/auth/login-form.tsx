...
import type { LoginUserCommandCorrected } from '@/types/user-types';
...
}) satisfies z.ZodType<LoginUserCommandCorrected>;
...
export function LoginForm({
    ...
    const form = useForm<LoginUserCommandCorrected>({
    ...
    const onSubmit = async (data: LoginUserCommandCorrected) => {
