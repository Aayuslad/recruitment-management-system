...
import z from 'zod';
import type { RegisterUserCommandCorrected } from '@/types/user-types';
...
}) satisfies z.ZodType<RegisterUserCommandCorrected>;
...
export function RegistrationForm({
    ...
    const form = useForm<RegisterUserCommandCorrected>({
    ...
    const onSubmit = async (data: RegisterUserCommandCorrected) => {
